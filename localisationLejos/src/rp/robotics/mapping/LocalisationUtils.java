...
public class LocalisationUtils {
	...
	public static GridMap createTrainingMap() {
		...
		lines.add(new Line(42f, 67f, 287f, 67f));
		lines.add(new Line(287f, 0, 287f, 67f));
		lines.add(new Line(257f, 0, 257f, 67f));

		lines.add(new Line(135f, 129f, 255f, 129f));
		lines.add(new Line(135f, 129f, 135f, height));

		lines.add(new Line(194f, 191f, 254f, 191f));
		lines.add(new Line(194f, 191f, 194f, height));
	...
	public static GridMap create2014Map1() {
		...
		lines.add(new Line(27, 78, 27, 108));

		// right

		lines.add(new Line(27, 108, 60, 108));

		// up

		lines.add(new Line(60, 108, 60, 76));

		// right

		lines.add(new Line(60, 76, 92, 76));

		// up

		lines.add(new Line(92, 76, 92, 42));

		// left

		lines.add(new Line(92, 42, 62, 42));

		// 2

		// right

		lines.add(new Line(126, 45, 206, 45));

		// right

		lines.add(new Line(126, 78, 206, 78));

		// 3

		// left

		lines.add(new Line(240, 45, 270, 45));

		// down

		lines.add(new Line(240, 45, 240, 79));

		// right

		lines.add(new Line(240, 79, 272, 79));

		// down

		lines.add(new Line(272, 79, 272, 113));

		// right

		lines.add(new Line(272, 113, 306, 113));

		// up

		lines.add(new Line(306, 113, 306, 83));

		// 4 center

		// down

		lines.add(new Line(149, 108, 149, 140));

		// right

		lines.add(new Line(149, 140, 179, 140));

		// down

		lines.add(new Line(179, 140, 179, 108));

		// 5

		// up

		lines.add(new Line(28, 168, 28, 138));

		// right

		lines.add(new Line(28, 138, 62, 138));

		// down

		lines.add(new Line(62, 138, 62, 169));

		// right

		lines.add(new Line(62, 169, 94, 169));

		// down

		lines.add(new Line(94, 169, 94, 203));

		// left

		lines.add(new Line(94, 203, 63, 203));

		// 6

		// right

		lines.add(new Line(126, 169, 206, 169));

		// right

		lines.add(new Line(126, 198, 206, 198));

		// 7

		// left

		lines.add(new Line(267, 198, 237, 198));

		// up

		lines.add(new Line(237, 198, 237, 168));

		// right

		lines.add(new Line(237, 168, 269, 168));

		// up

		lines.add(new Line(269, 168, 269, 138));

		// right

		lines.add(new Line(269, 138, 303, 138));

		// down

		lines.add(new Line(303, 138, 303, 168));
	...
	public static GridMap createKenMap() {
		...
		lines.add(new Line(40, height - 145, 284, height - 145));
		// new Line(255, height - 238, 255, height - 145),
		lines.add(new Line(255, height - 238, 255, height - 145));

		//
		// 3 - fix, 1.7 wide boards
		lines.add(new Line(366, height - 141, 324, height - 141));
		lines.add(new Line(324, height - 141, 324, height - 82));
		// 4
		lines.add(new Line(256, height - 110, 136, height - 110));
		lines.add(new Line(136, height - 110, 136, height - 0));
		lines.add(new Line(194, height - 110, 194, height - 77));
		lines.add(new Line(194, height - 77, 254, height - 77));
		lines.add(new Line(254, height - 50, 194, height - 50));
		lines.add(new Line(194, height - 50, 194, height - 0));
